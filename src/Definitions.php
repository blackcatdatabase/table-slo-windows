...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'slo_windows'; }
    public static function contractView(): string { return 'vw_slo_windows'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'name', 'objective', 'target_pct', 'window_interval', 'created_at' ]; }
    ...
    public static function jsonColumns(): array { return [ 'objective' ]; }
