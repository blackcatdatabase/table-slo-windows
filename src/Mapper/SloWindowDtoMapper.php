...
namespace BlackCat\Database\Packages\SloWindows\Mapper;

use BlackCat\Database\Packages\SloWindows\Dto\SloWindowDto;
use BlackCat\Database\Packages\SloWindows\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO SloWindowDto:
...
final class SloWindowDtoMapper
{
    ...
    /** @var string[] */
    private const FLOAT_COLS  = [ 'target_pct' ];
    /** @var string[] */
    private const JSON_COLS   = [ 'objective' ];
    /** @var string[] */
     ...
     * @return SloWindowDto
     */
    public static function fromRow(array $row): SloWindowDto
    {
        /** @var SloWindowDto */
    ...
    public static function fromRowOrNull(?array $row): ?SloWindowDto
    {
     ...
     *
     * @param SloWindowDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(SloWindowDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SloWindowDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SloWindowDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SloWindowDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SloWindowDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SloWindowDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SloWindowDto>
     */
