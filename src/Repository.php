...
use BlackCat\Database\Packages\SloWindows\Repository\SloWindowRepository;
...
{
    private SloWindowRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new SloWindowRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SloWindows\Dto\SloWindowDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SloWindows\Dto\SloWindowDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SloWindows\Dto\SloWindowDto|null
    {
