...
namespace BlackCat\Database\Packages\SloWindows;
...
use BlackCat\Database\Packages\SloWindows\Repository\SloWindowRepository as GeneratedRepository;
...
{
  private SloWindowRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SloWindowRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SloWindowRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SloWindows\Dto\SloWindowDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SloWindows\Dto\SloWindowDto|null { return $this->repo->getById($id, $asDto); }
