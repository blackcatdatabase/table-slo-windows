...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'name', 'objective', 'target_pct', 'window_interval', 'created_at' ];
    }
...
{
    return [ 'id', 'name', 'target_pct', 'window_interval', 'created_at' ];
}
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\SloWindows\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\SloWindows\Definitions::softDeleteColumn();
