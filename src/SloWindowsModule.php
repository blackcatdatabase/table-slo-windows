...
final class SloWindowsModule implements ModuleInterface
{
    public function name(): string { return 'table-slo_windows'; }
    public function table(): string { return 'slo_windows'; }
