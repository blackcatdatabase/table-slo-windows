...
namespace BlackCat\Database\Packages\SloWindows\Dto;
 ...
 */
final class SloWindowDto implements \JsonSerializable {
    public function __construct(
        public readonly int $id,
        #[\SensitiveParameter] public readonly string $name,
        public readonly array $objective,
        public readonly string $targetPct,
        public readonly string $windowInterval,
