...
- Pkg folder: [packages\slo-windows](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\slo-windows)
...
graph LR
  ...
  slo_windows["slo_windows"]:::center
  slo_status["slo_status"]:::inbound -->|FK| slo_windows
...
- Inbound (relies on this): "slo_status"
...
| [040_views_modules.mysql.sql](schema/modules/blackcat-sre/040_views_modules.mysql.sql) | mysql |
| [040_views_modules.postgres.sql](schema/modules/blackcat-sre/040_views_modules.postgres.sql) | postgres |
...
| [040_views_modules.mysql.sql](schema/modules/blackcat-sre/040_views_modules.mysql.sql) | mysql | package |
| [040_views_modules.postgres.sql](schema/modules/blackcat-sre/040_views_modules.postgres.sql) | postgres | package |
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package slo-windows -Apply
