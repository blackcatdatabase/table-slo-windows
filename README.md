...
| Pkg folder | [packages/slo-windows](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/slo-windows) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package slo-windows -Apply
